...
// -----------------------------------------
//
// Source: StartCenterBuyerPOTabLT.java
// Date  : 07 Nov 2019 19:23:45 PST
 ...
 * Automatically generated load test program.
 */
public class StartCenterBuyerPOTabLT extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "StartCenterBuyerPOTabLTExtParams.dat";// input file name for very large parameter values
	 ...
	 */
	public StartCenterBuyerPOTabLT()
	{
		super();
	}
	 ...
	 */
	public StartCenterBuyerPOTabLT(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("StartCenterBuyerPOTabLT", concurrentUsers, ParseArgs.getString(args, "-executionPlan"));
		...
		performanceData.setInfoText("StartCenterBuyerPOTabLT");
		...
		LoadtestPluginContext globalPluginContext = new LoadtestPluginContext(prxVersion, prxCharEncoding, new StartCenterBuyerPOTabLT());
		...
		if (hasExecutionPlan())
		{
			...
			try
			{
				...
				StartCenterBuyerPOTabLT simulatedUser = new StartCenterBuyerPOTabLT(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());
